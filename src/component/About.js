  ...
  return (
    <div className="home">
     ...
     <div className="row">
      ...
      <div ref={homeText} className="col-md-6 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
      <h2> <strong className="brand-name"> About us</strong> </h2>
      ...
      <div className="mt-3" >
      <NavLink exact to="/contact" className="btn-get-started nav-link">Get Connected</NavLink>
      </div>
      </div>
